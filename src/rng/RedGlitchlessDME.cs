public partial class RedGlitchless {
    public void DoubleMaxEther(bool silphBar = true) {
        ...
        // ClearCache();
        CacheState("forest", () => {
            Execute(SpacePath("DRRUUURRRRRRRRRRRRRRRRRRRRRURUUUUUURUUUUUUUUUULAUUUUUUUUUUUUULLLUUUUUUUUUUURRR"));
            ForceEncounter(Action.Right, 4, 0x0000);
            ClearText();
            ForceYoloball("POKE BALL");
            ClearText();
            No(); // pidgey caught
        ...
        CacheState("brock", () => {
            ...
            BattleSwitch("SQUIRTLE", new RbyTurn("TACKLE", Crit));
        ...
        CacheState("route3", () => {
            ...
            // ROUTE 3 TRAINER 2
            TalkTo(14, 4);
            ForceTurn(new RbyTurn("LEER"), new RbyTurn("QUICK ATTACK"));
            ForceTurn(new RbyTurn("HORN ATTACK"), new RbyTurn("QUICK ATTACK"));
            ForceTurn(new RbyTurn("HORN ATTACK"), new RbyTurn("TACKLE"));
            ForceTurn(new RbyTurn("LEER"), new RbyTurn("LEER", Miss));
            ForceTurn(new RbyTurn("HORN ATTACK"), new RbyTurn("WRAP", Miss));
            ForceTurn(new RbyTurn("HORN ATTACK"));
        ...
        CacheState("mtmoon", () => {
            ...
            ForceTurn(new RbyTurn("HORN ATTACK"), new RbyTurn("SMOG"));
            ForceTurn(new RbyTurn("MEGA PUNCH"));
        ...
        CacheState("bridge", () => {
            ...
            // RIVAL 2
            ClearText();
            ForceTurn(new RbyTurn("HORN ATTACK"), new RbyTurn("GUST", Crit));
            ForceTurn(new RbyTurn("HORN ATTACK"), new RbyTurn("SAND-ATTACK", Miss));
            ForceTurn(new RbyTurn("HORN ATTACK"));
            ForceTurn(new RbyTurn("HORN ATTACK"));
            ForceTurn(new RbyTurn("MEGA PUNCH"), new RbyTurn("QUICK ATTACK", Crit));
            ForceTurn(new RbyTurn("MEGA PUNCH"), new RbyTurn("VINE WHIP", Crit));
            ForceTurn(new RbyTurn("HORN ATTACK"));
        ...
        CacheState("boat", () => {
            ...
            ForceTurn(new RbyTurn("HORN ATTACK"));
            ForceTurn(new RbyTurn("MEGA PUNCH"), new RbyTurn("QUICK ATTACK", 10 | Crit));
            ForceTurn(new RbyTurn("THRASH"));
        ...
        CacheState("surge", () => {
            ...
            TalkTo(5, 1);
            ForceTurn(new RbyTurn("THRASH"));
            ForceTurn(new RbyTurn("THRASH"), new RbyTurn("QUICK ATTACK", 20));
